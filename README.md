...
- Developed the initial iteration of a swipe-based mobile job browsing feature to streamline job discovery.
- Built and enhanced backend services and APIs supporting the company-wide Mobile-Off Platform initiative, improving mobile search and application workflows.
- Awarded the Q4 2013 Poppendieck Award for high-impact delivery aligned with Lean/Agile engineering principles.
...
**Craft Desk**  
- Architecting and developing a full-stack inventory and tagging system (React + .NET Core API) to manage and search craft supplies by theme, color palette, and category.
- Designing a relational schema in SQLite to support many-to-many relationships (e.g., supplies ↔ tags) and flexible filtering scenarios.
...
**Observability:** Application Insights, Prometheus, Grafana, Loggly, Lens (OpenLens), Windows Event Log & flat-file log analysis (legacy COM/enterprise environments)  
...
### Hobbies 
Card Making, Travel, ATL UTD (Footie Mob Member, 2019)
